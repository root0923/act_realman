    ...
    with torch.inference_mode():
        try:
            ...
            while True:
                ...
                # 位置控制
                slave_arm.rm_movej(action, 20, 0, 0, 1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_dir', default='ckpts/real_single_arm', type=str, help='ckpt_dir', required=False)
    ...
    parser.add_argument('--task_name', default='real_single_arm', type=str, help='task_name', required=False)
    ...
    parser.add_argument('--chunk_size', default=18, type=int, help='chunk_size', required=False)
