...
class EpisodicDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print('output shape of dataloader', '\n', image_data.dtype, qpos_data.dtype, action_data.dtype, is_pad.dtype)
        # print('image_data shape:', image_data.shape)
        # print('qpos_data shape:', qpos_data.shape)
        # print('action_data shape:', action_data.shape)
        # print('is_pad shape:', is_pad.shape)
        # print('output dtype of dataloader', image_data.dtype, qpos_data.dtype, action_data.dtype, is_pad.dtype)
