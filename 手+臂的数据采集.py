...
MASTER_IP = "169.254.128.18"
SLAVE_IP = "169.254.128.19" # 改成从臂的IP地址
LOCAL_IP = "169.354.128.103" # 改成自己的IP地址
PORT=8080
class Listener():
    def __init__(self, local_ip, remote_ip, port=8080, recv_time=2, max_retries=10):
...
def collect_process():
    ...
    #init_pose = [-18, 18, -90, -33, -75, -183]  # 主臂从臂的初始位姿
...
if __name__ == "__main__":
    ...
    for episode in range(1, num_episodes + 1):
        ...
        # 保存当前组数据
        data_path = os.path.join(os.getcwd(), 'data_handchanges1', f'b{episode}')
        hdf5datapath = os.path.join(os.getcwd(), 'data_handchange1', 'data')
