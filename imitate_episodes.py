...
def main(args):
    ...
    # fixed parameters
    # 使用配置中的值或默认为6
    action_dim = task_config.get('action_dim', 8)
    ...
    for rollout_id in range(num_rollouts):
        ...
        with torch.inference_mode():
            ...
            for t in range(max_timesteps):
                ...
                print("post_process(raw_action):", action)
                # if use_actuator_net:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--position_embedding", default="sine", type=str, choices=("sine", "v2"), help="Type of positional embedding to use")
    parser.add_argument("--masks", action="store_true", help="Train segmentation head if the flag is provided")

    
    main(vars(parser.parse_args()))

    # python imitate_episodes.py   --task_name real_single_arm   --ckpt_dir ckpts/real_single_arm   --policy_class ACT   --batch_size 16   --seed 0   --num_steps 5000   --lr 1e-4   --kl_weight 10   --chunk_size 8   --hidden_dim 512   --dim_feedforward 3200
