...
class OGlove:
    ...
    def new(self,shared_values, update_event, now_pos):
        """
        Create a new instance of OGlove.
        :param shared_values: Shared values to store finger positions
        :param update_event: Event to signal updates
        :param now_pos: Current positions of the fingers
        :param serial: Path to serial port
        :param timeout: Timeout in milliseconds
        :return: New instance of OGlove
        """
        self.shared_values = shared_values
        self.update_event = update_event
        self.now_pos = now_pos
